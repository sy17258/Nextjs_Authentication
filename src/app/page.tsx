      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto">
            Experience the next generation of authentication with our secure,
            fast, and user-friendly platform. Built with modern technologies for
            the modern web.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-20">
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition duration-300">
              ...
              <p className="text-gray-600">
                Advanced security features including JWT tokens, email
                verification, and encrypted password storage to keep your data
                safe.
              </p>
            </div>
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition duration-300">
              ...
              <p className="text-gray-600">
                Optimized for performance with Next.js 15, ensuring quick load
                times and smooth user interactions across all devices.
              </p>
            </div>
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition duration-300">
              ...
              <p className="text-gray-600">
                Intuitive interface with modern design principles, making
                authentication a seamless experience for your users.
              </p>
            </div>
          </div>
        </div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-indigo-100">
                      Advanced password hashing and security measures
                    </p>
                  </div>
                </div>
                <div className="flex items-start space-x-4">
        ...
        <div className="text-center mt-20">
          ...
          <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto">
            Join thousands of developers who trust NextAuth for their
          ...
          <div className="text-center">
            ...
            <div className="">
              <p className="text-gray-400 text-sm">
                © 2025 Developed by Shivam Yadav. Built with Next.js and
                TypeScript.
              </p>
            </div>
          </div>
